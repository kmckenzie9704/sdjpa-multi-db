...
public class CardDatabaseConfiguration {
    ...
    public DataSourceProperties cardDatabaseProperties()
    {
    ...
    public DataSource cardDataSource(@Qualifier("cardDatabaseProperties") DataSourceProperties cardDatabaseProperties) {

        return cardDatabaseProperties.initializeDataSourceBuilder()
    ...
    public LocalContainerEntityManagerFactoryBean cardEntityManagerFactory
        ...
        LocalContainerEntityManagerFactoryBean efb =
         builder.dataSource(cardDataSource).packages(CreditCard.class).persistenceUnit("card").build();
