...
@EnableJpaRepositories(basePackages = "guruspringframework.sdjpamultidb.repositories.pan",
        entityManagerFactoryRef = "panManagerFactory", transactionManagerRef = "panTransactionManager")
@Configuration
public class PanDatabaseConfiguration {
    ...
    @Bean
    @Primary
    public LocalContainerEntityManagerFactoryBean panManagerFactory
        ...
        LocalContainerEntityManagerFactoryBean efb =
         builder.dataSource(panDataSource).packages(CreditCardPAN.class).persistenceUnit("pan").build();
    ...
    public PlatformTransactionManager panTransactionManager
            (@Qualifier("panManagerFactory") LocalContainerEntityManagerFactoryBean panEntityManagerFactory){
